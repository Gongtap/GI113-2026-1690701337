...
namespace Lab04
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //Console.WriteLine("+-------------------+");  // แค่ title, WriteLine การพิมพ์ขึ้นบรรทัดใหม่
            //Console.Write("Name your hero: ");  // การใช้ Write การพิมพ์ต่อบรรทัดเดิม
            //string playerName = Console.ReadLine();  // ReadLine() คืออ่านบรรทัดปัจจุบันที่ต้องป้อนข้อมูลเอง (เป็นข้อความ, string)
